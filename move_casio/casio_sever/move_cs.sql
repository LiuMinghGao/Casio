...
CREATE DATABASE move_cs CHARSET=UTF8;
USE move_cs;

/**用户**/
CREATE TABLE move_cs_user(
...
/**插入用户信息**/
INSERT INTO move_cs_user VALUES
(NULL,"123456","a123456"),
(NULL,"654321","a654321");

/**轮播图**/
CREATE TABLE move_cs_carousel(
...
/**插入轮播图**/
INSERT INTO  move_cs_carousel VALUES
...
INSERT INTO  move_cs_news VALUES
(null,"标题1","新品资讯",now(),"内容1111"),
(null,"标题2","新品资讯",now(),"内容2222"),
(null,"标题3","新品资讯",now(),"内容3333"),
(null,"标题4","新品资讯",now(),"内容4444"),
(null,"标题5","新品资讯",now(),"内容5555"),
(null,"标题6","新品资讯",now(),"内容6666"),
(null,"标题7","新品资讯",now(),"内容7777"),
(null,"标题8","新品资讯",now(),"内容8888"),
(null,"标题9","新品资讯",now(),"内容9999"),
(null,"标题10","新品资讯",now(),"内容101010"),
(null,"标题11","新品资讯",now(),"内容1111111"),
(null,"标题12","新品资讯",now(),"内容121212"),
(null,"标题13","新品资讯",now(),"内容131313"),
(null,"标题14","新品资讯",now(),"内容141414"),
(null,"标题15","新品资讯",now(),"内容151515"),
(null,"标题16","新品资讯",now(),"内容161616"),
(null,"标题17","新品资讯",now(),"内容171717");

#创建表 move_cs_comment 评论表
CREATE TABLE move_cs_comment(
  id INT PRIMARY KEY AUTO_INCREMENT,
  content VARCHAR(2000),
  ctime DATETIME,
  nid   INT
);
INSERT INTO move_cs_comment VALUES(null,'1',now(),1);
INSERT INTO move_cs_comment VALUES(null,'2',now(),1);
INSERT INTO move_cs_comment VALUES(null,'3',now(),1);
INSERT INTO move_cs_comment VALUES(null,'4',now(),1);
INSERT INTO move_cs_comment VALUES(null,'5',now(),1);
INSERT INTO move_cs_comment VALUES(null,'6',now(),1);
INSERT INTO move_cs_comment VALUES(null,'7',now(),1);
INSERT INTO move_cs_comment VALUES(null,'8',now(),1);
INSERT INTO move_cs_comment VALUES(null,'9',now(),1);
INSERT INTO move_cs_comment VALUES(null,'10',now(),1);
INSERT INTO move_cs_comment VALUES(null,'11',now(),1);
INSERT INTO move_cs_comment VALUES(null,'12',now(),1);
INSERT INTO move_cs_comment VALUES(null,'13',now(),1);
INSERT INTO move_cs_comment VALUES(null,'14',now(),1);
INSERT INTO move_cs_comment VALUES(null,'15',now(),1);
INSERT INTO move_cs_comment VALUES(null,'16',now(),1);
INSERT INTO move_cs_comment VALUES(null,'17',now(),1);
INSERT INTO move_cs_comment VALUES(null,'18',now(),1);
INSERT INTO move_cs_comment VALUES(null,'19',now(),1);
INSERT INTO move_cs_comment VALUES(null,'20',now(),1);
INSERT INTO move_cs_comment VALUES(null,'21',now(),1);
INSERT INTO move_cs_comment VALUES(null,'22',now(),1);
...
#创建商品详情 move_cs_details
CREATE TABLE move_cs_details(
...
INSERT INTO move_cs_details VALUES
